        ...
        <div class="flex flex-col lg:flex-row lg:justify-start gap-14">
            ...
            <div class="w-1/2 lg:w-1/3">
                ...
                <div class="flex justify-between gap-4">
                    <ul class="space-y-4">
                        <li><a href="{{ route('filament.club.auth.register') }}" class="text-md text-white tracking-wider rtl:tracking-normal">{{ __('footer.links.gamer_login') }}</a></li>
                        <li><a href="{{ route('filament.club.auth.register') }}" class="text-md text-white tracking-wider rtl:tracking-normal">{{ __('footer.links.club_login') }}</a></li>
                        <li><a href="{{ route('filament.gamer.auth.register') }}" class="text-md text-white tracking-wider rtl:tracking-normal">{{ __('footer.links.gamer_register') }}</a></li>
                        <li><a href="{{ route('filament.club.auth.register') }}" class="text-md text-white tracking-wider rtl:tracking-normal">{{ __('footer.links.club_register') }}</a></li>
